...
{
    public class QuestionChangePublish
    {
        public QuestionChangePublish()
        {
        }

        public async Task SendMessageAsync(Question question
            , string method)
        {
            ...
            try
            {
                ...
                using (var channel = await connection.CreateChannelAsync())
                {
                    if (connection.IsOpen && channel.IsOpen)
                    {
                        ...
                        var message = JsonSerializer.Serialize(question);
